...
function makeStyles(t: ThemeColors) {
  return StyleSheet.create({
    ...
    sidebarEmptyText: { color: t.textMuted, fontSize: 12 },
    ...
    listItemActive: { backgroundColor: t.accentSoft },
    listItemBar: {
      position: "absolute",
      left: 0,
      top: 4,
    ...
    listItemText: { color: t.textSecondary, fontSize: 13, fontWeight: "500" },
    listItemTextActive: { color: t.textPrimary, fontWeight: "600" },
    listItemCount: { color: t.textMuted, fontSize: 10, marginTop: 1 },
    ...
    formBtnCancel: { backgroundColor: t.surface, borderWidth: 1, borderColor: t.border },
    ...
    detailTitle: { color: t.textPrimary, fontSize: 17, fontWeight: "700" },
    detailSubtitle: { color: t.textMuted, fontSize: 11, marginTop: 2 },
    refreshBtn: {
      width: 32,
      height: 32,
      borderRadius: 8,
    ...
    searchResultIconText: { color: t.accent, fontSize: 12, fontWeight: "700" },
    resultSym: { color: t.textPrimary, fontSize: 13, fontWeight: "700" },
    resultName: { color: t.textMuted, fontSize: 11, marginTop: 1 },
    resultExchangePill: {
      backgroundColor: t.surface,
      borderRadius: 4,
      paddingHorizontal: 6,
    ...
    resultExchangeText: { color: t.textMuted, fontSize: 9, fontWeight: "600", letterSpacing: 0.5 },
    ...
    textUp: { color: t.green },
    textDown: { color: t.red },
    ...
    symbolTicker: { color: t.textPrimary, fontSize: 13, fontWeight: "700" },
    symbolFullName: { color: t.textMuted, fontSize: 10, marginTop: 1 },
    changePill: {
      borderRadius: 5,
      paddingHorizontal: 7,
      paddingVertical: 3,
    },
    pillUp: { backgroundColor: t.greenSoft },
    pillDown: { backgroundColor: t.redSoft },
    ...
    emptyText: { color: t.textMuted, fontSize: 13, textAlign: "center", lineHeight: 19 },

    // Mobile tabs
    mobileTabsScroll: { borderBottomWidth: 1, borderBottomColor: t.border },
    mobileTabs: {
      flexDirection: "row",
      alignItems: "center",
      paddingHorizontal: 12,
    ...
    mobileTabActive: { backgroundColor: t.accentSoft, borderColor: t.accent },
    mobileTabText: { color: t.textMuted, fontSize: 12, fontWeight: "500" },
    mobileTabTextActive: { color: t.accent, fontWeight: "700" },
    mobileNewTab: {
      width: 30,
      height: 30,
      borderRadius: 8,
...
export default function WatchlistScreen() {
            ...
            <View key={w.id} style={[styles.listItem, isActive && styles.listItemActive]}>
              ...
              <View style={styles.listItemActions}>
                ...
                <TouchableOpacity onPress={() => handleDeleteList(w)} style={styles.iconBtn}>
                  <Feather name="trash-2" size={11} color={colors.red} />
                </TouchableOpacity>
              </View>
            </View>
          );
  ...
  const detail = (
    <View style={styles.detail}>
      {!activeList ? (
        <View style={styles.center}>
          <Feather name="bar-chart-2" size={44} color={colors.textMuted} />
                ...
                <View style={styles.searchDropdown}>
                  {searchResults.map((r, i) => (
                    ...
                    >
                      ...
                      <Feather name="plus" size={14} color={colors.accent} style={{ marginLeft: 8 }} />
                    </TouchableOpacity>
                  ))}
                </View>
              )}
