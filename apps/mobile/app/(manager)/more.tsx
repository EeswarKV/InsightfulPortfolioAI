...
function makeStyles(t: ThemeColors) {
  return StyleSheet.create({
    ...
    menuLabel: { color: t.textPrimary, fontSize: 15, fontWeight: "600" },
    menuDesc: { color: t.textMuted, fontSize: 11, marginTop: 2 },
    badge: {
    ...
    logoutBtn: {
      ...
      backgroundColor: `${t.red}0D`,
    },
    logoutText: { color: t.red, fontSize: 14, fontWeight: "600" },
  });
}
